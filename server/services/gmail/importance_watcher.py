...
_DEFAULT_SEEN_PATH = _DATA_DIR / "gmail_seen.db"
...
def get_important_email_watcher() -> ImportantEmailWatcher:
    ...
    if _watcher_instance is None:
        ...
        _watcher_instance = ImportantEmailWatcher(
            poll_interval_seconds=settings.important_email_poll_interval_seconds,
            lookback_minutes=settings.important_email_lookback_minutes,
        )
